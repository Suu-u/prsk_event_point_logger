...
BORDER_FILEPATH = "border_cp3.csv"
# BORDER_HEADER = ["date", "point"]
START_TIME = datetime.datetime.fromisoformat("2024-03-14 20:00:00.000000")
DAYS = 3
PER_DAY = [0, 7485373, 15483279, 29484689]
...
plt.figure()
plt.plot(x, y_actual, marker='.', color='fuchsia')
plt.scatter(x_ticks, PER_DAY, marker='o', color='fuchsia')
